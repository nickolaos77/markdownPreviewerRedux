...
/***/ function(module, exports, __webpack_require__) {
	...
	//redux
	var textChanged = function textChanged(newText) {
	  return {
	    type: 'TEXT_CHANGE',
	    newText: newText
	  };
	...
	var reducer = function reducer() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Heading Redux\n=======\n\nSub-heading\n-----------\n \n### Another deeper heading\n \nParagraphs are separated\nby a blank line.\n\nLeave 2 spaces at the end of a line to do a  \nline break\n\nText attributes *italic*, **bold**, \n`monospace`, ~~strikethrough~~ .\n\nShopping list:\n\n  * apples\n  * oranges\n  * pears\n\nNumbered list:\n\n  1. apples\n  2. oranges\n  3. pears\n\nThe rain---not the reign---in\nSpain.\n\n *[Herman Fassett](https://freecodecamp.com/hermanfassett)*';
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: 'rawMarkUp',
	    value: function rawMarkUp(value) {
	      var rawMarkup = (0, _marked2.default)(value, { sanitize: true });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'col-xs-12 col-sm-6', style: { marginTop: 60 } },
	          _react2.default.createElement(
	            'textarea',
	            { onChange: this.handleChange, rows: '24', cols: '50' },
	            this.props.text
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('span', { dangerouslySetInnerHTML: this.rawMarkUp(this.props.text) })
	        )
	      );
	    }
	  }]);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    submitNewText: function submitNewText(text) {
	...
	_reactDom2.default.render(_react2.default.createElement(AppWrapper, null), document.getElementById('app'));
